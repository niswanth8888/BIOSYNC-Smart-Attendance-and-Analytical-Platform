...
export default function Sidebar() {
  ...
  const navItems = [
    { path: '/', label: 'DASHBOARD', icon: <ServerCog size={18} /> },
    { path: '/combine', label: 'COMBINE SHEETS', icon: <Combine size={18} /> },
    { path: '/report', label: 'RANGE REPORT', icon: <CalendarRange size={18} /> },
  ];
